...
export const HeroBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-nexa-secondary/20 rounded-full blur-[64px] sm:blur-[128px] animate-pulse-slow will-change-transform"></div>
      <div className="absolute bottom-0 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-nexa-primary/20 rounded-full blur-[64px] sm:blur-[128px] animate-pulse-slow delay-1000 will-change-transform"></div>
